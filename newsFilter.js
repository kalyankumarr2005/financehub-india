/**
 * newsFilter.js — Score and select the most relevant articles
 * (Same logic as before — no external dependencies)
 */
...
const STAT_PATTERN = /\d[\d,.]*\s*(%|cr|crore|lakh|billion|trillion|bps|rs\.?|₹)/i;
